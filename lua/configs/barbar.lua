...
vim.g.bufferline = {
   ...
   icon_separator_active = User.icons.separators.round.left, -- Icono de separacion activo
   icon_separator_inactive = User.icons.separators.line.favorite, -- Icono de separacion Inactivo
   icon_close_tab = User.icons.others.close, -- Icono para cerrar el buffer
   icon_close_tab_modified = User.icons.git.modifier, -- Icono cuando se modifica el buffer
   icon_pinned = User.icons.others.pinned, -- No se en que se usa.
