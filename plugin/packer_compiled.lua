...
_G.packer_plugins = {
  ...
  ["document-color.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/document-color.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/typescript.nvim",
